...
Ext.define('dht.view.dhcp.serverstatus.ServerStatus', {
  ...
  requires: [
    ...
    'dht.view.dhcp.serverstatus.ServerStatusController',
    'dht.view.dhcp.serverstatus.ServerStatusModel',
    'dht.ux.plugin.ClearButton',
    'dht.ux.plugin.EnterKeyHandler'
  ],
  xtype: 'serverstatus',
  title: '시스템 모니터링',
  viewModel: { type: 'serverstatus' },
