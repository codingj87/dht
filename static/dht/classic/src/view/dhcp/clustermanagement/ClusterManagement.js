 ...
 */
Ext.define('dht.view.dhcp.clustermanagement.ClusterManagement', {
  extend: 'Ext.panel.Panel',

  requires: [
    'dht.view.dhcp.clustermanagement.ClusterManagementController',
    'dht.view.dhcp.clustermanagement.ClusterManagementModel',
    'Ext.button.Button',
    'Ext.grid.Panel',
      ...
      items: [
        {
          ...
          columns: {
            ...
            items: [
              { text: '클러스터 명', dataIndex: 'name' },
              { text: 'VIP', dataIndex: 'vip' },
              { text: '생성 시간', dataIndex: 'ctime' },
              { text: '수정 시간', dataIndex: 'mtime' }
            ]
          },
          listeners: {
            itemclick: 'handleGridSelect'
          },
                      ...
                      formatter: function(params) {
                        if (params instanceof Array) {
                          ...
                          for (var i = 0; i < params.length; i++) {
                            var group_name = params[i].seriesId.split('_')[0];
                            var o = _.findWhere(groups, { group: group_name });
                            if (o) {
                              o.data.push({
